...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      ...
      {/* Sidebar */}
      <aside className={`${sidebarOpen ? 'w-64' : 'w-16'} bg-indigo-900 text-white flex flex-col transition-all duration-300`}>
        ...
        <div className="p-3 border-t border-indigo-800">
          ...
          <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-indigo-200 hover:bg-indigo-800 hover:text-white transition w-full text-sm font-medium"
          >
